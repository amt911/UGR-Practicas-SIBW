...
--
-- Host: mysql:3306
-- Generation Time: Apr 23, 2022 at 09:38 AM
...
INSERT INTO `Contiene` (`ID`, `Ruta Imagen`) VALUES
(1, '3090_2.png'),
(1, '3090.png'),
(5, 'AMD_CPU.png'),
(1, 'controller.png'),
...
(6, 'HDD.png'),
(9, 'intel_cpu.png'),
(7, 'nintendo_switch_oled_white_1.png'),
(3, 'NVME.png'),
(4, 'PS5.png'),
(8, 'Series_X.png');
...
INSERT INTO `Imagenes` (`Ruta Imagen`, `Descripcion`) VALUES
('3090_2.png', 'Vista generalmente apreciada por muchos la verdad'),
('3090.png', 'Vista frontal'),
('AMD_CPU.png', ''),
('comment.png', ''),
('controller.png', ''),
('HDD.png', NULL),
('intel_cpu.png', ''),
('nintendo_switch_oled_white_1.png', ''),
('NVME.png', ''),
('PS5.png', ''),
('Series_X.png', '');
...
ALTER TABLE `Contiene`
  ADD PRIMARY KEY (`ID`,`Ruta Imagen`),
  ADD KEY `Ruta Imagen` (`Ruta Imagen`);
...
--
ALTER TABLE `Contiene`
  ADD CONSTRAINT `Contiene_ibfk_1` FOREIGN KEY (`Ruta Imagen`) REFERENCES `Imagenes` (`Ruta Imagen`),
  ADD CONSTRAINT `Contiene_ibfk_2` FOREIGN KEY (`ID`) REFERENCES `Productos` (`ID`);
