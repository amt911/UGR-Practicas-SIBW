...
--
-- Host: mysql:3306
-- Generation Time: Jun 02, 2022 at 09:34 AM
...
(105, 120, 'static/images/crosshair_idUser120.png', 'crosshair'),
(106, 120, 'static/images/default_user_idUser120.png', 'user'),
(107, 120, 'static/images/trollface_idUser120.jpg', 'trollfacea'),
(108, 120, 'static/images/diagrama_idUser120.png', 'diagrama');
...
(120, 429.69, 'Producto de prueba', '<p>Este es un producto que va a hacer que me acueste ya pls</p>', 'titulo', 'asd');
...
(12, 'Andres', 'a.merlo.truji10@gmail.com', '$2y$10$JWJrTYaMBQUBJuBwKJkCw.VGlSgxU1V88UnbihZClPSRvbHA1QTMO', 1, 1, 1, 'Hombre', 'static/images/ZDVORKB2B4GUPIPWBC3SN5IJXI_idUser12.jpg', 'asd', 'AND'),
(21, 'asd', 'asd@asd.asd', '$2y$10$11PhWBIwb0r7ifuJt4XlQeEfVlWTN3bwgEHUU7IC58upQHfqME/96', 0, 0, 0, 'Hombre', 'static/images/trollface_idUser21.jpg', 'asd', 'AGO');
...
--
ALTER TABLE `Imagenes`
  MODIFY `ID_Imagen` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=114;
